...
에픽을 실질적인 태스크 단위인 업무로 분해:

#### 업무 작성 규칙

각 업무는 **에픽 목표 달성을 위한 구체적 작업**:
...
업무를 **개인 to-do list**로 분해:

#### 하위 업무 작성 규칙

각 하위 업무는 **업무 수행을 위한 세부 작업**:
- 2-4시간 내 완료 가능
- 코드 레벨의 구체적 작업
- **데일리/위클리 리포트에 미노출**
